...
/// `functions/src/seed/seedPregeneratedQuestions.ts` — there's no in-app way
/// to create a group. Home-turf categories don't belong to any group.
class CategoryGroupModel extends Equatable {
  ...
  /// English display name. Null/empty for anything not seeded with one
  /// (there's currently no such case for groups, but [displayName] falls
  /// back to [name] regardless).
  final String? nameEn;
  ...
  @override
  List<Object?> get props => [id, name, nameEn, order, iconKey];
}
